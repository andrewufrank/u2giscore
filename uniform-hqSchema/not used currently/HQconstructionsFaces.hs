...
incenter2triple :: (obj, [obj]) -> Maybe (MorphCountry, (obj, obj))
...
--   Identity
--   [(obj, Double)]
area2facesM ::forall rel obj . (MorphsHQ rel, Ord obj, Ord rel)  => State (Store obj rel)    [(obj, Double)]
area2facesM  = fmap (map (second area2faces)) coords2faces 

-- circum2facesM ::State  CatStoreTessShort   [ (ObjTessShort, Maybe V2D)]
circum2facesM::forall rel obj . (MorphsHQ rel, Ord obj, Ord rel)  => State (Store obj rel)     [(obj, Maybe V2D)]
...
incenter2facesM :: forall rel obj . (MorphsHQ rel, Ord obj, Ord rel)  => State (Store obj rel)    [(obj, Maybe V2D)]
incenter2facesM = fmap (map (second ( (incenter2faces  )))) coords2faces

incenter2facesTriples  ::forall rel obj . (MorphsHQ rel, Ord obj, Ord rel)  => State (Store obj rel)     [Maybe (MorphCountry, (obj, obj))]
incenter2facesTriples = fmap (map  ( incenter2triple)) coords2faces 
incircumCenter2facesTriples ::forall rel obj . (MorphsHQ rel, Ord obj, Ord rel)  => State (Store obj rel)    [Maybe (Tup3 obj MorphCountry)]
