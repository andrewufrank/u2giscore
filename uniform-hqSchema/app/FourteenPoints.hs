...
cat61 :: Store ObjCountry MorphCountry
...
addtoCat :: [(Tup3 ObjCountry MorphCountry)] -> Store ObjCountry MorphCountry -> Store ObjCountry MorphCountry
addtoCat ts cat0 = storeBatch (map wrapIns ts) cat0

cat62 :: Store ObjCountry MorphCountry
