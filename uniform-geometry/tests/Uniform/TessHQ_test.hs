...
vertexFourList ="[(VertexId 0,VertexData {_location = Point2 0.0 0.0, _vData = ()}),(VertexId 1,VertexData {_location = Point2 1.5 1.5, _vData = ()}),(VertexId 2,VertexData {_location = Point2 0.0 2.0, _vData = ()}),(VertexId 3,VertexData {_location = Point2 2.0 0.0, _vData = ()})]"
vertexDataFour = "[(VertexId 0,VertexData {_location = Point2 0.0 0.0, _vData = ()}),(VertexId 1,VertexData {_location = Point2 1.5 1.5, _vData = ()}),(VertexId 2,VertexData {_location = Point2 0.0 2.0, _vData = ()}),(VertexId 3,VertexData {_location = Point2 2.0 0.0, _vData = ()})]"
...
planeGraph2Four = "PlaneGraph {_graph = PlanarGraph embedding = Permutation {_orbits = [[Dart (Arc 0) +1,Dart (Arc 1) +1,Dart (Arc 2) +1],[Dart (Arc 3) +1,Dart (Arc 4) +1,Dart (Arc 2) -1],[Dart (Arc 4) -1,Dart (Arc 0) -1],[Dart (Arc 1) -1,Dart (Arc 3) -1]], _indexes = [(0,0),(2,1),(0,1),(3,0),(0,2),(1,2),(1,0),(3,1),(1,1),(2,0)]} , vertexData = [VertexData {_location = Point2 0.0 0.0, _vData = ()},VertexData {_location = Point2 1.5 1.5, _vData = ()},VertexData {_location = Point2 0.0 2.0, _vData = ()},VertexData {_location = Point2 2.0 0.0, _vData = ()}] , rawDartData = [(),(),(),(),(),(),(),(),(),()] , faceData = [(),(),()]}"
