...
p1 = Pnv2d 1 (V2 1 2):: Pnv2

test_p1 = assertEqual "Pnv2d {_p2id = 1, _v2 = V2 1.0 2.0}" (showT p1)

test_v2zero = assertEqual "Pnv2d {_p2id = 0, _v2 = V2 0.0 0.0}" (showT (zero::Pnv2))
...
fiveV2 :: [V2d]
fiveV2 = map point2d_v2 fivePoint2d
...
test_ccw_t1a = assertBool (ccw_test (fivePoint2d !! 0) (fivePoint2d !! 1) (fivePoint2d !! 2))
